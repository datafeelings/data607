...
*If you want to run the code on your machine, download the folder with the code and data from [GitHub](https://github.com/datafeelings/data607/tree/Week_4/week_4) and change the folder paths in the code to the downloaded directory.*  
